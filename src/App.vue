<template>
    <div id="app">
        ...
        <router-view ref="child" :delFlagState="delFlag" @child-tell-me-somethings="listenToMyBoy"></router-view>
<!--         <Cart ref="child" :delFlagState="delFlag" @child-tell-me-somethings="listenToMyBoy"></Cart>
...
export default {
    ...
    methods: {
        ...
        delProduct: function() {
            this.$refs.child.delProduct() //父组件调用子组件方法
        }
    }
}
</script>
